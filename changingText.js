...
const typingSpeed = 90; // Speed of typing each character
const deletingSpeed = 90; // Speed of deleting each character
const pauseAtEnd = 1400; // Pause at the end of a word
